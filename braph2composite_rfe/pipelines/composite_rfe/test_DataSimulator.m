...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	dsim = DataSimulator( ...
		...
		DataSimulator.GR_ID, DataSimulator.getPropDefault(DataSimulator.GR_ID), ...
	...
	for prop = 1:1:DataSimulator.getPropNumber()
		...
		% excluded props
		if any(prop == [DataSimulator.TEMPLATE DataSimulator.EXPORT_DATA DataSimulator.BA])
			continue
		end
...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	dsim_1 = DataSimulator( ...
		...
		DataSimulator.P_MAX, dsim_0.getCallback(10), ..., ...
		DataSimulator.P_MIN, dsim_0.getCallback(11), ..., ...
		DataSimulator.P, dsim_0.getCallback(12), ..., ...
		DataSimulator.D, dsim_0.getCallback(13), ..., ...
		DataSimulator.N, dsim_0.getCallback(14), ..., ...
		DataSimulator.TIME_STEP, dsim_0.getCallback(15), ..., ...
		DataSimulator.N_SUB, dsim_0.getCallback(16), ..., ...
		DataSimulator.DIRECTORY, dsim_0.getCallback(17), ..., ...
		DataSimulator.GR_ID, dsim_0.getCallback(18), ..., ...
		DataSimulator.GRAPH_DATA, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_DATA, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_GR, DataSimulator.getNoValue(), ...
		DataSimulator.EXPORT_DATA, DataSimulator.getNoValue(), ...
	...
	dsim_2 = DataSimulator( ...
		...
		DataSimulator.P_MAX, dsim_1.getCallback(10), ..., ...
		DataSimulator.P_MIN, dsim_1.getCallback(11), ..., ...
		DataSimulator.P, dsim_1.getCallback(12), ..., ...
		DataSimulator.D, dsim_1.getCallback(13), ..., ...
		DataSimulator.N, dsim_1.getCallback(14), ..., ...
		DataSimulator.TIME_STEP, dsim_1.getCallback(15), ..., ...
		DataSimulator.N_SUB, dsim_1.getCallback(16), ..., ...
		DataSimulator.DIRECTORY, dsim_1.getCallback(17), ..., ...
		DataSimulator.GR_ID, dsim_1.getCallback(18), ..., ...
		DataSimulator.GRAPH_DATA, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_DATA, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_GR, DataSimulator.getNoValue(), ...
		DataSimulator.EXPORT_DATA, DataSimulator.getNoValue(), ...
	...
	dsim_3 = DataSimulator( ...
		...
		DataSimulator.P_MAX, dsim_2.getCallback(10), ..., ...
		DataSimulator.P_MIN, dsim_2.getCallback(11), ..., ...
		DataSimulator.P, dsim_2.getCallback(12), ..., ...
		DataSimulator.D, dsim_2.getCallback(13), ..., ...
		DataSimulator.N, dsim_2.getCallback(14), ..., ...
		DataSimulator.TIME_STEP, dsim_2.getCallback(15), ..., ...
		DataSimulator.N_SUB, dsim_2.getCallback(16), ..., ...
		DataSimulator.DIRECTORY, dsim_2.getCallback(17), ..., ...
		DataSimulator.GR_ID, dsim_2.getCallback(18), ..., ...
		DataSimulator.GRAPH_DATA, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_DATA, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_GR, DataSimulator.getNoValue(), ...
		DataSimulator.EXPORT_DATA, DataSimulator.getNoValue(), ...
