...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	dsim = DataSimulator( ...
		...
		DataSimulator.WAITBAR, DataSimulator.getPropDefault(DataSimulator.WAITBAR), ...
		DataSimulator.BA, DataSimulator.getPropDefault(DataSimulator.BA), ...
		DataSimulator.P_MAX, DataSimulator.getPropDefault(DataSimulator.P_MAX), ...
		DataSimulator.P_MIN, DataSimulator.getPropDefault(DataSimulator.P_MIN), ...
		...
		DataSimulator.EFF_NODES, DataSimulator.getPropDefault(DataSimulator.EFF_NODES), ...
		DataSimulator.EFF_BR_DICT, DataSimulator.getPropDefault(DataSimulator.EFF_BR_DICT), ...
		...
		DataSimulator.SIM_DIRECTORY, DataSimulator.getPropDefault(DataSimulator.SIM_DIRECTORY), ...
		DataSimulator.SIM_GR_ID, DataSimulator.getPropDefault(DataSimulator.SIM_GR_ID), ...
		DataSimulator.GRAPH_TEMPLATE, DataSimulator.getPropDefault(DataSimulator.GRAPH_TEMPLATE), ...
		DataSimulator.SIM_G_DICT, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_SUB_DICT, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_GR, DataSimulator.getNoValue(), ...
		DataSimulator.EXPORT_DATA, DataSimulator.getNoValue(), ...
		DataSimulator.EXPORT_BA, DataSimulator.getNoValue(), ...
		DataSimulator.PLOT_GRAPH, DataSimulator.getNoValue(), ...
		DataSimulator.PLOT_PATHLENGTH, DataSimulator.getNoValue() ...
		);
	 
	for prop = 1:1:DataSimulator.getPropNumber()
	 
		% excluded props
		if any(prop == [DataSimulator.TEMPLATE DataSimulator.BA DataSimulator.EXPORT_DATA DataSimulator.EXPORT_BA DataSimulator.PLOT_GRAPH DataSimulator.PLOT_PATHLENGTH DataSimulator.EFF_NODES DataSimulator.EFF_BR_DICT])
			continue
		end
...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	dsim_1 = DataSimulator( ...
		...
		DataSimulator.NOTES, DataSimulator.getPropDefault(DataSimulator.NOTES), ...
		DataSimulator.TOSTRING, DataSimulator.getNoValue(), ...
		DataSimulator.WAITBAR, dsim_0.getCallback(9), ..., ...
		DataSimulator.BA, dsim_0.getCallback(10), ..., ...
		DataSimulator.P_MAX, dsim_0.getCallback(11), ..., ...
		DataSimulator.P_MIN, dsim_0.getCallback(12), ..., ...
		DataSimulator.P, dsim_0.getCallback(13), ..., ...
		DataSimulator.D, dsim_0.getCallback(14), ..., ...
		DataSimulator.N, dsim_0.getCallback(15), ..., ...
		DataSimulator.EFF_NODES, dsim_0.getCallback(16), ..., ...
		DataSimulator.EFF_BR_DICT, dsim_0.getCallback(17), ..., ...
		DataSimulator.TIME_STEP, dsim_0.getCallback(18), ..., ...
		DataSimulator.N_SUB, dsim_0.getCallback(19), ..., ...
		DataSimulator.SIM_DIRECTORY, dsim_0.getCallback(20), ..., ...
		DataSimulator.SIM_GR_ID, dsim_0.getCallback(21), ..., ...
		DataSimulator.GRAPH_TEMPLATE, dsim_0.getCallback(22), ..., ...
		DataSimulator.SIM_G_DICT, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_SUB_DICT, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_GR, DataSimulator.getNoValue(), ...
		DataSimulator.EXPORT_DATA, DataSimulator.getNoValue(), ...
	...
	dsim_2 = DataSimulator( ...
		...
		DataSimulator.NOTES, DataSimulator.getPropDefault(DataSimulator.NOTES), ...
		DataSimulator.TOSTRING, DataSimulator.getNoValue(), ...
		DataSimulator.WAITBAR, dsim_1.getCallback(9), ..., ...
		DataSimulator.BA, dsim_1.getCallback(10), ..., ...
		DataSimulator.P_MAX, dsim_1.getCallback(11), ..., ...
		DataSimulator.P_MIN, dsim_1.getCallback(12), ..., ...
		DataSimulator.P, dsim_1.getCallback(13), ..., ...
		DataSimulator.D, dsim_1.getCallback(14), ..., ...
		DataSimulator.N, dsim_1.getCallback(15), ..., ...
		DataSimulator.EFF_NODES, dsim_1.getCallback(16), ..., ...
		DataSimulator.EFF_BR_DICT, dsim_1.getCallback(17), ..., ...
		DataSimulator.TIME_STEP, dsim_1.getCallback(18), ..., ...
		DataSimulator.N_SUB, dsim_1.getCallback(19), ..., ...
		DataSimulator.SIM_DIRECTORY, dsim_1.getCallback(20), ..., ...
		DataSimulator.SIM_GR_ID, dsim_1.getCallback(21), ..., ...
		DataSimulator.GRAPH_TEMPLATE, dsim_1.getCallback(22), ..., ...
		DataSimulator.SIM_G_DICT, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_SUB_DICT, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_GR, DataSimulator.getNoValue(), ...
		DataSimulator.EXPORT_DATA, DataSimulator.getNoValue(), ...
	...
	dsim_3 = DataSimulator( ...
		...
		DataSimulator.NOTES, DataSimulator.getPropDefault(DataSimulator.NOTES), ...
		DataSimulator.TOSTRING, DataSimulator.getNoValue(), ...
		DataSimulator.WAITBAR, dsim_2.getCallback(9), ..., ...
		DataSimulator.BA, dsim_2.getCallback(10), ..., ...
		DataSimulator.P_MAX, dsim_2.getCallback(11), ..., ...
		DataSimulator.P_MIN, dsim_2.getCallback(12), ..., ...
		DataSimulator.P, dsim_2.getCallback(13), ..., ...
		DataSimulator.D, dsim_2.getCallback(14), ..., ...
		DataSimulator.N, dsim_2.getCallback(15), ..., ...
		DataSimulator.EFF_NODES, dsim_2.getCallback(16), ..., ...
		DataSimulator.EFF_BR_DICT, dsim_2.getCallback(17), ..., ...
		DataSimulator.TIME_STEP, dsim_2.getCallback(18), ..., ...
		DataSimulator.N_SUB, dsim_2.getCallback(19), ..., ...
		DataSimulator.SIM_DIRECTORY, dsim_2.getCallback(20), ..., ...
		DataSimulator.SIM_GR_ID, dsim_2.getCallback(21), ..., ...
		DataSimulator.GRAPH_TEMPLATE, dsim_2.getCallback(22), ..., ...
		DataSimulator.SIM_G_DICT, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_SUB_DICT, DataSimulator.getNoValue(), ...
		DataSimulator.SIM_GR, DataSimulator.getNoValue(), ...
		DataSimulator.EXPORT_DATA, DataSimulator.getNoValue(), ...
