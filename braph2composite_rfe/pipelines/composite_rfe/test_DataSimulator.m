...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	dsim = DataSimulator( ...
		...
		DataSimulator.PLOT_CLUSTERING, DataSimulator.getNoValue() ...
		);
	 
	for prop = 1:1:DataSimulator.getPropNumber()
	 
		% excluded props
		if any(prop == [DataSimulator.TEMPLATE DataSimulator.BA DataSimulator.EXPORT_DATA DataSimulator.EXPORT_BA DataSimulator.PLOT_GRAPH DataSimulator.PLOT_CLUSTERING])
			continue
		end
