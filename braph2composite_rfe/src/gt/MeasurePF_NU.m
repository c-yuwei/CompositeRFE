classdef MeasurePF_NU < MeasurePF
	...
	properties (Constant) % properties
		...
		LAYER = MeasurePF.getPropNumber() + 2;
		LAYER_TAG = 'LAYER';
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case MeasurePF_NU.LAYER
						tag = MeasurePF_NU.LAYER_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case MeasurePF_NU.LAYER
					prop_category = MeasurePF_NU.LAYER_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case MeasurePF_NU.LAYER
					prop_format = MeasurePF_NU.LAYER_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case MeasurePF_NU.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the panel figure for nodal unilayer measure (MeasurePF_NU).';
