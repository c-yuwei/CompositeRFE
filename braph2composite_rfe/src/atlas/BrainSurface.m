classdef BrainSurface < ConcreteElement
	...
	methods (Static) % inspection
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case BrainSurface.VERTEX_NUMBER
					prop_description = 'VERTEX_NUMBER (data, scalar) is the number of triangle vertices of the brain surface.';
				case BrainSurface.COORDINATES
					prop_description = 'COORDINATES (data, matrix) are the coordinates of the triangle vertices of the brain surface.';
				case BrainSurface.TRIANGLES_NUMBER
					prop_description = 'TRIANGLES_NUMBER (data, scalar) is the number of triangles of the brain surface.';
				case BrainSurface.TRIANGLES
					prop_description = 'TRIANGLES (data, matrix) are the triads of coordinates of the triangles of the brain surface.';
