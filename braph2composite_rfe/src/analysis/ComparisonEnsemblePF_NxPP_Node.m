classdef ComparisonEnsemblePF_NxPP_Node < PanelProp
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = subclasses('ComparisonEnsemblePF_NxPP_Node', [], [], true);
		end
		function prop_list = getProps(category)
			...
			if nargin == 0
				prop_list = [ ...
					PanelProp.getProps() ...
						ComparisonEnsemblePF_NxPP_Node.DROPDOWN ...
						];
				return
			end
		...
		function prop_number = getPropNumber(varargin)
			...
			prop_number = numel(ComparisonEnsemblePF_NxPP_Node.getProps(varargin{:}));
		end
		function check_out = existsProp(prop)
			...
			check = any(prop == ComparisonEnsemblePF_NxPP_Node.getProps());
			
			if nargout == 1
				check_out = check;
			elseif ~check
				error( ...
					[BRAPH2.STR ':ComparisonEnsemblePF_NxPP_Node:' BRAPH2.WRONG_INPUT], ...
					[BRAPH2.STR ':ComparisonEnsemblePF_NxPP_Node:' BRAPH2.WRONG_INPUT '\n' ...
		...
		function check_out = existsTag(tag)
			...
			comparisonensemblepf_nxpp_node_tag_list = cellfun(@(x) ComparisonEnsemblePF_NxPP_Node.getPropTag(x), num2cell(ComparisonEnsemblePF_NxPP_Node.getProps()), 'UniformOutput', false);
			check = any(strcmp(tag, comparisonensemblepf_nxpp_node_tag_list));
		...
		function prop = getPropProp(pointer)
			...
			if ischar(pointer)
				comparisonensemblepf_nxpp_node_tag_list = cellfun(@(x) ComparisonEnsemblePF_NxPP_Node.getPropTag(x), num2cell(ComparisonEnsemblePF_NxPP_Node.getProps()), 'UniformOutput', false);
				prop = find(strcmp(pointer, comparisonensemblepf_nxpp_node_tag_list)); % tag = pointer
			else % numeric
				prop = pointer;
			end
		end
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					case ComparisonEnsemblePF_NxPP_Node.DROPDOWN
						tag = ComparisonEnsemblePF_NxPP_Node.DROPDOWN_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				case ComparisonEnsemblePF_NxPP_Node.DROPDOWN
					prop_category = ComparisonEnsemblePF_NxPP_Node.DROPDOWN_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				case ComparisonEnsemblePF_NxPP_Node.DROPDOWN
					prop_format = ComparisonEnsemblePF_NxPP_Node.DROPDOWN_FORMAT;
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				case ComparisonEnsemblePF_NxPP_Node.DROPDOWN
					prop_default = Format.getFormatDefault(Format.HANDLE, ComparisonEnsemblePF_NxPP_Node.getPropSettings(prop));
				case ComparisonEnsemblePF_NxPP_Node.ELCLASS
				...
				case ComparisonEnsemblePF_NxPP_Node.TEMPLATE
					prop_default = Format.getFormatDefault(Format.ITEM, ComparisonEnsemblePF_NxPP_Node.getPropSettings(prop));
				case ComparisonEnsemblePF_NxPP_Node.ID
				...
				case ComparisonEnsemblePF_NxPP_Node.PROP
					prop_default = ComparisonEnsemblePF_NU.NODE;
				case ComparisonEnsemblePF_NxPP_Node.HEIGHT
					prop_default = s(4);
				otherwise
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			%  Error id: €BRAPH2.STR€:ComparisonEnsemblePF_NxPP_Node:€BRAPH2.WRONG_INPUT€
			% 
			% Alternative forms to call this method are (POINTER = PROP or TAG):
			...
			switch prop
				case ComparisonEnsemblePF_NxPP_Node.DROPDOWN % __ComparisonEnsemblePF_NxPP_Node.DROPDOWN__
					check = Format.checkFormat(Format.HANDLE, value, ComparisonEnsemblePF_NxPP_Node.getPropSettings(prop));
				case ComparisonEnsemblePF_NxPP_Node.TEMPLATE % __ComparisonEnsemblePF_NxPP_Node.TEMPLATE__
					check = Format.checkFormat(Format.ITEM, value, ComparisonEnsemblePF_NxPP_Node.getPropSettings(prop));
				otherwise
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(pr, prop, varargin)
			...
			switch prop
				...
				case ComparisonEnsemblePF_NxPP_Node.X_DRAW % __ComparisonEnsemblePF_NxPP_Node.X_DRAW__
					value = calculateValue@PanelProp(pr, PanelProp.X_DRAW, varargin{:}); % also warning
					if value
					    pr.memorize('DROPDOWN')
					end
					
				case ComparisonEnsemblePF_NxPP_Node.UPDATE % __ComparisonEnsemblePF_NxPP_Node.UPDATE__
				...
				case ComparisonEnsemblePF_NxPP_Node.REDRAW % __ComparisonEnsemblePF_NxPP_Node.REDRAW__
				...
				case ComparisonEnsemblePF_NxPP_Node.DELETE % __ComparisonEnsemblePF_NxPP_Node.DELETE__
