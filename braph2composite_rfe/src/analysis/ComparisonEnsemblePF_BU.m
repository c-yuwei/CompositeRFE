classdef ComparisonEnsemblePF_BU < ComparisonEnsemblePF
	...
	properties (Constant) % properties
		...
		LAYER = ComparisonEnsemblePF.getPropNumber() + 2;
		LAYER_TAG = 'LAYER';
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case ComparisonEnsemblePF_BU.LAYER
						tag = ComparisonEnsemblePF_BU.LAYER_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case ComparisonEnsemblePF_BU.LAYER
					prop_category = ComparisonEnsemblePF_BU.LAYER_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case ComparisonEnsemblePF_BU.LAYER
					prop_format = ComparisonEnsemblePF_BU.LAYER_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case ComparisonEnsemblePF_BU.LAYER
					prop_description = 'LAYER (figure, scalar) is the layer number of the binodal group comparison figure.';
				case ComparisonEnsemblePF_BU.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the ComparisonEnsemblePF_BU.';
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				...
				case ComparisonEnsemblePF_BU.LAYER % __ComparisonEnsemblePF_BU.LAYER__
					check = Format.checkFormat(Format.SCALAR, value, ComparisonEnsemblePF_BU.getPropSettings(prop));
