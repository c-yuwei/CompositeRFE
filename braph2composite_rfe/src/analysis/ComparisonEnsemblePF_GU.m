classdef ComparisonEnsemblePF_GU < ComparisonEnsemblePF
	...
	properties (Constant) % properties
		LAYER = ComparisonEnsemblePF.getPropNumber() + 1;
		LAYER_TAG = 'LAYER';
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					case ComparisonEnsemblePF_GU.LAYER
						tag = ComparisonEnsemblePF_GU.LAYER_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				case ComparisonEnsemblePF_GU.LAYER
					prop_category = ComparisonEnsemblePF_GU.LAYER_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				case ComparisonEnsemblePF_GU.LAYER
					prop_format = ComparisonEnsemblePF_GU.LAYER_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				case ComparisonEnsemblePF_GU.LAYER
					prop_description = 'LAYER (figure, scalar) is the layer number of the global group comparison figure.';
				case ComparisonEnsemblePF_GU.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the ComparisonEnsemblePF_GU.';
	...
	methods (Static) % checkProp
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				case ComparisonEnsemblePF_GU.LAYER % __ComparisonEnsemblePF_GU.LAYER__
					check = Format.checkFormat(Format.SCALAR, value, ComparisonEnsemblePF_GU.getPropSettings(prop));
