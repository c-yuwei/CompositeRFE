	...
	methods (Static) % inspection
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case NNRegressorMLP_CrossValidationPF_Scatter.NNCV
					prop_description = 'NNCV (metadata, item) is the neural network cross-validation.';
				case NNRegressorMLP_CrossValidationPF_Scatter.PREDICTIONS_VALUE
				...
				case NNRegressorMLP_CrossValidationPF_Scatter.ELCLASS
					prop_description = 'ELCLASS (constant, string) is the class of the panel scatter plot for a cross-validation with MLP regressors.';
				case NNRegressorMLP_CrossValidationPF_Scatter.NAME
					prop_description = 'NAME (constant, string) is the name of the panel scatter plot for a cross-validation with MLP regressors.';
				case NNRegressorMLP_CrossValidationPF_Scatter.DESCRIPTION
					prop_description = 'DESCRIPTION (constant, string) is the description of the panel scatter plot for a cross-validation with MLP regressors.';
				case NNRegressorMLP_CrossValidationPF_Scatter.TEMPLATE
					prop_description = 'TEMPLATE (parameter, item) is the template of the panel scatter plot for a cross-validation with MLP regressors.';
				case NNRegressorMLP_CrossValidationPF_Scatter.ID
					prop_description = 'ID (data, string) is a few-letter code for the panel scatter plot for a cross-validation with MLP regressors.';
				case NNRegressorMLP_CrossValidationPF_Scatter.LABEL
					prop_description = 'LABEL (metadata, string) is an extended label of the panel scatter plot for a cross-validation with MLP regressors.';
				case NNRegressorMLP_CrossValidationPF_Scatter.NOTES
					prop_description = 'NOTES (metadata, string) are some specific notes about the panel scatter plot for a cross-validation with MLP regressors.';
