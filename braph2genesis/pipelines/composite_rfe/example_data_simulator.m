...
g_temp = GraphWU();
dsim_1 = DataSimulator('P_MAX', 0.8, 'P_MIN', 0.8, 'D', 4, 'N', 20, 'EFF_NODES', eff_nodes, 'TIME_STEP', 200, 'N_SUB', 25, 'SIM_DIRECTORY', output_folder, 'SIM_GR_ID', 'SimGroup1', 'GRAPH_TEMPLATE', g_temp);
...
dsim_2 = DataSimulator('P_MAX', 0.02, 'P_MIN', 0.02, 'D', 4, 'N', 20, 'EFF_NODES', eff_nodes, 'TIME_STEP', 200, 'N_SUB', 25, 'SIM_DIRECTORY', output_folder, 'SIM_GR_ID', 'SimGroup2', 'GRAPH_TEMPLATE', g_temp);
...
dsim = DataSimulator('P_MAX', 1, 'P_MIN', 0, 'D', 6, 'N', 50, 'TIME_STEP', 200, 'N_SUB', 50, 'SIM_DIRECTORY', output_folder, 'SIM_GR_ID', 'TEXT_BOOOK_DATA', 'GRAPH_TEMPLATE', g_temp);
