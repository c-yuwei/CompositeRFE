classdef Exporter < ConcreteElement
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'Exporter'  'ExporterGroupSubjectFUN_TXT'  'ExporterGroupSubjectFUN_XLS'  'ExporterBrainAtlasTXT'  'ExporterBrainAtlasXLS'  'ExporterPipelineBRAPH2' }; %CET: Computational Efficiency Trick
		end
